      ...
      {isOpen ? (
        <>
                ...
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      data-testid="delivery-option-radio"
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-3 border rounded-rounded px-6 mb-2 hover:shadow-borders-interactive-with-active",
                        {
                          "border-ui-border-interactive":
                            showPickupOptions === PICKUP_OPTION_ON,
                        }
          ...
          {showPickupOptions === PICKUP_OPTION_ON && (
            <div className="grid">
              <div className="flex flex-col gap-0.5">
                ...
                <span className="text-ui-fg-muted txt-medium leading-tight">
                  {siteConfig.chechout.choosestore}
                </span>
              </div>
          ...
          <div className="mt-2">
            ...
            <Button
              size="large"
              className="bg-green-600 hover:bg-green-500 ml-auto block"
              onClick={handleSubmit}
              isLoading={isLoading}
              disabled={!cart.shipping_methods?.[0]}
              data-testid="submit-delivery-option-button"
        ...
        <div className="text-small-regular">
          {cart && (cart.shipping_methods?.length ?? 0) > 0 && (
            <div className="flex flex-col w-1/3 gap-0.5">
              <Text className="txt-medium-plus text-ui-fg-base">Method</Text>
              <Text className="txt-medium text-ui-fg-subtle leading-tight">
                {cart.shipping_methods!.at(-1)!.name}{" "}
                {convertToLocale({
                  amount: cart.shipping_methods!.at(-1)!.amount!,
                  currency_code: cart?.currency_code,
